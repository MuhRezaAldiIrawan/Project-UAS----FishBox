 ...
 <span class="symbol-input100">
     <img src="<?= base_url('assets_regis/images/person-fill.svg'); ?>" alt="IMG" aria-hidden="true" />
 </span>
 </div>
 ...
 <div class="wrap-input100 validate-input" data-validate="Confirm Password is required">
     <input class="input100" type="password" d="password2" name="password2" placeholder="Confirm Password" />
     <span class="focus-input100"></span>
     <span class="symbol-input100">
         <i class="fa fa-lock" aria-hidden="true"></i>
     </span>
